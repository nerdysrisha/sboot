...
public class Lab000 {
    ...
    public String greetTheWorld() {
        System.out.println("Sending greetings. DB Hostname and Port from application.properties / environment / config map / secrets "+config.getDbHostname()+":"+  config.getDbPort());
